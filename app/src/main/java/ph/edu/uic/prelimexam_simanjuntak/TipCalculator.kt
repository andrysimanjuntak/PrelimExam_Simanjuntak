...
import ph.edu.uic.prelimexam_simanjuntak.databinding.ActivityTipCalculatorBinding
...
class TipCalculator : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnBackTipCalculator.setOnClickListener {
            val email = intent.getStringExtra("email")
            val intent = Intent(this@TipCalculator, MainActivity::class.java)
